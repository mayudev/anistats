            ...
            <div class="details">
                <div class="details-content" v-if="selectedMonth && selectedYear">
                    ...
                    <div class="details-list">
                        <div class="details-entry" v-for="entry in selected" :key="entry.id">
                            <img class="entry-image" :src="entry.cover">
                            <div class="entry-title">
                                <a :href="'https://anilist.co/'+entry.type.toLowerCase()+'/'+entry.id" target="_blank" rel="nofollow">{{ entry.title }}</a></div>
                        </div>
                    </div>
                </div>
                <div v-else>
