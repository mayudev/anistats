<template>
  <div class="sidebar">
    ...
    <div class="category" v-if="state.mediaType != 'manga'">
      ...
      <MenuItem @click="emitToggle" icon="history" to="/history/anime"
        >History</MenuItem
      >
    </div>
    <div class="category" v-if="state.mediaType != 'anime'">
      <span class="category-header">Manga</span>
      <MenuItem @click="emitToggle" icon="book-open" to="/list/manga"
        >List</MenuItem
      >
      <MenuItem @click="emitToggle" icon="history" to="/history/manga"
        >History</MenuItem
      >
    </div>
